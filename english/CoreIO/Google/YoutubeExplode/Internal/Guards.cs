...
namespace YoutubeExplode.Internal
{
    internal static class Guards
    {
        ...
        {
            return t; // >= TimeSpan.Zero ? t : throw new ArgumentOutOfRangeException(argName, t, "Cannot be negative.");
        }

        public static int GuardNotNegative(this int i, string argName = null)
        {
            return i; // >= 0 ? i : throw new ArgumentOutOfRangeException(argName, i, "Cannot be negative.");
        }
        ...
        {
            return i; // > 0 ? i : throw new ArgumentOutOfRangeException(argName, i, "Cannot be negative or zero.");
        }
    }
}