...
namespace CefSharp.Example
{
    ...
    public static class ScriptedMethods
    {
        ...
        public static bool ActiveElementAcceptsTextInput(this IFrame frame)
        {
            if (frame == null)
            {
            ...
            var response = frame.EvaluateScriptAsync(script).Result;
            if (!response.Success)
            {
        ...
        public static   bool ElementWithIdExists(this IFrame frame, string id)
        {
            if (frame == null)
            {
                throw new ArgumentException("An IFrame instance is required.", "frame");
