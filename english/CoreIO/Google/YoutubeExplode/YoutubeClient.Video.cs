...
namespace YoutubeExplode
{
    public partial class YoutubeClient
    {
        private string GetVideoEmbedPageRawAsync(string videoId)
        {
            ...
            return _httpClient.GetStringAsync(url); //.ConfigureAwait(false);
        }
        ...
        private PlayerSource GetVideoPlayerSourceAsync(string sourceUrl)
        {
            ...
            var sourceRaw = _httpClient.GetStringAsync(sourceUrl);//.ConfigureAwait(false);
        ...
        public MediaStreamInfoSet GetVideoMediaStreamInfosAsync(string videoId)
        {
            ...
            if (dashManifestUrl.IsNotBlank())
            {
                ...
                // Get the manifest
                var response = _httpClient.GetStringAsync(dashManifestUrl); //.ConfigureAwait(false);
