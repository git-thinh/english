...
namespace test
{
    public partial class Browser : Form, IExampleView
    {
        ...
        public Browser()
        {
            ...
            web_view = new WebView("https://google.com.vn", new BrowserSettings());
        ...
        {
            goButton.Text = is_loading ? "Stop" : "Go";
            //goButton.Image = is_loading ? Properties.Resources.nav_plain_red : Properties.Resources.nav_plain_green;
